<?php
    ...
    //print_r($result);
    //print_r($userInfo);
    //$empinfo_array = json_encode($userInfo);
   // foreach($userInfo as $userInfos) {
   //   printf($userInfos["employee_fname"]);
  //  }
    //print_r($emp)
    ...
    <div id="employee_info" class="Profile">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="tail"><?php foreach($userInfo as $userInfos) { printf($userInfos["employee_fname"]);} ?></div>
        </div>
        <hr>
        <div class="row">
          <h6 class="head">Date of Birth</h6>
          <div class="tail"><?php foreach($userInfo as $userInfos) { printf($userInfos["employee_dob"]);} ?></div>
        </div>
        <hr>
        <div class="row">
          <h6 class="head">Email</h6>
          <div class="tail"><?php foreach($userInfo as $userInfos) { printf($userInfos["employee_email"]);} ?></div>
        </div>
        <hr>
        <div class="row">
          <h6 class="head">Phone</h6>
          <div class="tail"><?php foreach($userInfo as $userInfos) { printf($userInfos["employee_phone"]);} ?></div>
        </div>
        <hr>
        <div class="row">
          <h6 class="head">Address</h6>
          <div class="tail"><?php foreach($userInfo as $userInfos) { printf($userInfos["employe_address"]);} ?></div>
        </div>
      </div>
